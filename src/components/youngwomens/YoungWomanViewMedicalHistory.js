    ...
    <>
      ...
      <div className='app-body form-all create-young-woman'>
        ...
        <form className="mt-3 select-box" name="medicalHistoryForm" id="medicalHistoryForm" onSubmit={handleFormSubmit}>
          ...
          <div className={`form-group ${formData["digestive_system_type"].errorClass} ${digestiveTypeClass}`}>
            <label><span className="d-block">Digestive system <span className="text-danger">*</span></span></label>
            <Select className='form-control select-multi' isMulti value={selectedDigestiveOptions} onChange={(values) =>  handleChange1(values, 'digestive_system_type')} options={digestiveOption} onFocus={() =>  setActiveClass('digestive_system_type')}/>
