...
function YoungWomanViewMedicalHistory(){
  ...
  return(
    <>
      ...
      <div className='app-body form-all create-young-woman'>
        <p><small>View Young Women Medical History</small></p>
        <form className="mt-3" name="medicalHistoryForm" id="medicalHistoryForm">
          ...
          <div className={`form-group`}>
            ...
            <select className="form-control" value={formData["urinary_problems_type"].value ? formData["urinary_problems_type"].value : ''} name="urinary_problems_type" id="urinary_problems_type">
              <option value="">Select</option>
              <option value="0">None</option>
          ...
          <div className={`form-group`}>
            ...
            <select className="form-control" value={formData["periods_type"].value ? formData["periods_type"].value : ''} name="periods_type" id="periods_type">
              <option value="">Select</option>
              <option value="0">None</option>
...
export default YoungWomanViewMedicalHistory;