...
function YoungWomanUploadDoctorPrescriptions(){
        ...
        <div className='app-top-box d-flex align-items-center justify-content-between'>
          <div className='app-top-left d-flex align-items-center'>
            <div className='scroll-back'>
              <Link to={`/youngwomens/young-woman-prescriptions/${editAccountKey}/${prescriptionType}`} className=''>
...
export default YoungWomanUploadDoctorPrescriptions;