...
function BasicInformationPatient(){
        ...
        <div className="app-body basic-info">
          ...
          <form className="basic-information" name="basic_information" id="basic_information" onSubmit={handleFormSubmit}>
            <div className={`form-group ${formData["basicInfoName"].errorClass}`}>
              ...
              <input type="text" className="form-control" name="basicInfoName" id="basicInfoName" placeholder="Patient name" onChange={handleChange} value={formData["basicInfoName"].value ? formData["basicInfoName"].value : ''}/>
...
export default BasicInformationPatient;