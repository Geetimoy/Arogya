        ...
        <div className='login-container'>
          ...
          <div className='login-box signup'>
            ...
            <form className='select-box' onSubmit={handleFormSubmit}>
              ...
              <div>
              <p>By registering you read & agreed to the {(systemContext.systemDetails.thp_system_name) ? systemContext.systemDetails.thp_system_name.split(" - ")[0] : ''} <Link to ="/termsofuse" className='primary-color'>Terms of Use</Link> & <Link to="/disclaimer" className='primary-color'>Disclaimer</Link></p>
              </div>
