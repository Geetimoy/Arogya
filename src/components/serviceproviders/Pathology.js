        ...
        <div className='col-12 mb-3'>
          <div className='button-box-providers'>
           <ul className='p-0 m-0'>
              <li><span className='fw-bold min-width'>Name :</span> Dr. Lalpathlab</li>
              <li><span className='fw-bold'>Location :</span> Salua, Chinar Park</li>
              <li><span className='fw-bold'>Contact :</span> 9876543210</li>
              <li><span className='fw-bold'>Services :</span> Accurate tests, reliable results.
Your trusted partner in diagnostics.</li>
            </ul>
          </div>
        </div>
        <div className='col-12 mb-3'>
