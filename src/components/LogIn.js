...
import { faEye, faLongArrowAltLeft, faEyeSlash } from '@fortawesome/free-solid-svg-icons';
...
function LogIn() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    if(errorCounter > 0){
      ...
      jsonData['device_token']  = "fpDnSllATPC2-RQURuALJy:APA91bHjjUGG7g88GHiu2qz1Gm9PCjCbEQvOTFpU74Ffcwt9JPSi-03eLb-LqWmKhJG2TZgZGaUuolEU7G_IBVKoo2OLf5Ge_KwsMpJ0_g0lFYnR5TjgoCTTokp9s-IpaoX1AUMI-hMu";
          ...
          <div className='login-box'>
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <div className={`form-group ${errorClass.username}`}>
                ...
                <input type={passwordType ? `password` : `text`} id="userpassword" name="userpassword" className='form-control' onChange={handleChange}/>
