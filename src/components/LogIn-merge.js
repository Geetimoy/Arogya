      ...
      <div className="login-container">
        ...
        <div className="login-box">
          ...
          <form onSubmit={handleLoginSubmit}>
            ...
            <p className='text-center'>&copy; {(new Date().getFullYear())} {systemContext.systemDetails.thp_system_name}. {(systemContext.systemDetails.thp_system_id > 0) && <span>Powered by <Link to={systemContext.systemDetails.thp_sp_global_url} target="_blank" className="primary-color">{systemContext.systemDetails.thp_sp_global_name}</Link></span>}</p>
