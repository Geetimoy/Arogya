    ...
    <>
      ...
      <div className="app-body janani profile-listing services">
        <div className='add-patient align-items-center d-flex justify-content-between'>
          ...
          {
            (decryptedLoginDetails.account_type == '5') && <Link to="/janani/create-janani-doctor" className='btn btn-sm btn-primary primary-bg-color border-0'>Add Janani</Link>
          }
        </div>
          ...
          {jananiList.map((janani, index) => (
            <div className='col-6' key={janani.account_id}>
              <div className='button-box'>
                ...
                <Link onClick={() => { showChart(janani.janani_name, janani.account_key, janani.janani_age, janani.janani_gender) }} to={`#`} className='primary-color'>  Charts</Link>
                </div>
