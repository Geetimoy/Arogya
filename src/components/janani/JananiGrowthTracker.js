...
import MetricChart from '../../util/janani/MetricChart';
import {Modal, Button} from 'react-bootstrap'; 

import HeightGrowthChart from '../../util/janani/HeightGrowthChart';
import WeightGrowthChart from '../../util/janani/WeightGrowthChart';
import BMIGrowthChart from '../../util/janani/BMIGrowthChart';
//import MidArmGrowthChart from '../../util/janani/MidArmGrowthChart';
...
function JananiGrowthTracker() {
  ...
  const fetchGrowthData = async () => {
    ...
    var response = await fetch(`${API_URL}/getJananiHistorySummary`, {
        method: "POST",
        headers: {
  ...
  const fetchMetricData = async () => {
    ...
    var response = await fetch(`${API_URL}/getJananiChartHistory`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const [formData, setFormData] = useState({
      janani_weight: { category: 1, value: "" },
      janani_height: { category: 2, value: "" },
      janani_temperature: { category: 4, value: "" },
      janani_heart_rate: { category: 6, value: "" },
      janani_mid_arm: { category: 8, value: "" },
      janani_blood_pressure: { category: 9, value: "" },
      janani_spo2: { category: 10, value: "" },
      janani_diabetic: { category: 11, value: "" },
    });
  ...
  const handleFormSubmit = async (e) => {
        ...
        jsonData["janani_cat_value"]         = formData;
  
        if(decryptedLoginDetails.account_type === '5'){
          var response = await fetch(`${API_URL}/jananiPeriodicHealthDataAddFromDoctorLogin`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
          ...
          var response = await fetch(`${API_URL}/jananiPeriodicHealthDataAddFromVolunteerLogin`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
    ...
    <>
        ...
        <div className='app-top-box d-flex align-items-center justify-content-between'>
          <div className='app-top-left d-flex align-items-center'>
            <div className='scroll-back'>
              {
                (redirectedFrom === 'from-listing') && <Link to="/janani" className=''>
                ...
                (latestGrowthData && Object.keys(latestGrowthData).length) ? <>
                  
                  {
                    latestGrowthData[Object.keys(latestGrowthData)[0]].weight && <tr>
                      ...
                      <td><span>{ latestGrowthData[Object.keys(latestGrowthData)[0]].weight_range } Kg</span> <Link to={`/janani/growth-tracker/history/${editAccountKey}/${redirectedFrom}/weight`} className='primary-color'>(History)</Link></td> 
                    </tr>
                  } 

                  {
                    latestGrowthData[Object.keys(latestGrowthData)[0]].height && <tr>
                      ...
                      <td><span>{ latestGrowthData[Object.keys(latestGrowthData)[0]].height_range } Cm </span><Link to={`/janani/growth-tracker/history/${editAccountKey}/${redirectedFrom}/height`} className='primary-color'>(History)</Link></td> 
                    </tr>
                  }

                  {
                      latestGrowthData[Object.keys(latestGrowthData)[0]].bmi && <tr>
                        ...
                        <td><span>{ latestGrowthData[Object.keys(latestGrowthData)[0]].bmi_range } </span><Link to={`/janani/growth-tracker/history/${editAccountKey}/${redirectedFrom}/bmi`} className='primary-color'>(History)</Link></td> 
                      </tr>
                  }
                  
                  {
                    ...
                    //   <td>{ latestGrowthData[Object.keys(latestGrowthData)[0]].mid_arm_range } <Link to={`/janani/growth-tracker/history/${editAccountKey}/${redirectedFrom}/mid_arm`} className='primary-color'>(History)</Link></td> 
                    // </tr>
                  }
      ...
      <Modal show={modalGrowthDetailsShow} onHide={modalGrowthDetailsClose} className='growth-details'>
        ...
        <Modal.Body> 
          ...
          <div className='form-group mb-3'>
            <label htmlFor='janani_height'>Height (in cm)</label>
            <input type="text" className='form-control' name="janani_height" id="janani_height" placeholder='Enter Height in cm' onChange={handleChange} value={formData["janani_height"] ? formData["janani_height"].value : ''}/>
          </div>
          <div className='form-group mb-3'>
            <label htmlFor='janani_weight'>Weight (in kg)</label>
            <input type="text" className='form-control' name="janani_weight" id="janani_weight" placeholder='Enter Weight in kg' onChange={handleChange} value={formData["janani_weight"] ? formData["janani_weight"].value : ''}/>
          </div>
          <div className='form-group mb-3'>
            <label htmlFor='janani_temperature'>Body Temperature (in Fahrenheit)</label>
            <input type="text" className='form-control' name="janani_temperature" id="janani_temperature" placeholder='Enter Body Temperature in °F' onChange={handleChange} value={formData["janani_temperature"] ? formData["janani_temperature"].value : ''}/>
          </div>
          <div className='form-group mb-3'>
            <label htmlFor='janani_spo2'>Blood Oxygen Level SpO2</label>
            <input type="text" className='form-control' name="janani_spo2" id="janani_spo2" placeholder='Enter Blood Oxygen Level in %' onChange={handleChange} value={formData["janani_spo2"] ? formData["janani_spo2"].value : ''}/>
          </div>
          <div className='form-group mb-3'>
            <label htmlFor='janani_heart_rate'>Heart Rate (per minute)</label>
            <input type="text" className='form-control' name="janani_heart_rate" id="janani_heart_rate" placeholder='Enter Heart Rate per Minute' onChange={handleChange} value={formData["janani_heart_rate"] ? formData["janani_heart_rate"].value : ''}/>
          </div>
          {/* <div className='form-group mb-3'>
          ...
          <div className='form-group mb-3'>
            <label htmlFor='janani_blood_pressure'>Blood Pressure</label>
            <input type="text" className='form-control' name="janani_blood_pressure" id="janani_blood_pressure" placeholder='Enter Blood Pressure' onChange={handleChange} value={formData["janani_blood_pressure"] ? formData["janani_blood_pressure"].value : ''}/>
          </div>
          <div className='form-group mb-3'>
            <label htmlFor='janani_diabetic'>Are you Diabetic?  </label>
            <input type="text" className='form-control' name="janani_diabetic" id="janani_diabetic" placeholder='Enter Sugar Level' onChange={handleChange} value={formData["janani_diabetic"] ? formData["janani_diabetic"].value : ''}/>
          </div>
...
export default JananiGrowthTracker;