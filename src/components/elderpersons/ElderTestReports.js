...
function ElderTestReports(){
  ...
  const listReports = async (searchKey) => {
      ...
      if(decryptedLoginDetails.account_type === '5'){
        ...
        var response = await fetch(`${API_URL}/fetchTestReportForElderFromDoctorLogin`, {
          method: "POST",
          headers: {
        ...
        var response = await fetch(`${API_URL}/fetchTestReportForElder`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const [deleteTestReportFileId, setDeleteTestReportFileId]           = useState('');
    ...
    const deleteTestReport = async () => {
      ...
      if(decryptedLoginDetails.account_type === '5'){
        ...
        var response = await fetch(`${API_URL}/deleteTestReportForElderFromDoctorLogin`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        var response = await fetch(`${API_URL}/deleteTestReportForElder`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    <>
      ...
      <div className="app-body test-reports">
        ...
        <div className='add-patient align-items-center d-flex justify-content-between'>
          ...
          <Link className='btn btn-sm btn-primary primary-bg-color border-0 ms-2' to={`/elderpersons/elder-upload-test-reports/${editAccountKey}/${appointmentId}`}>Upload</Link></div>
