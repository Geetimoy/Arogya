...
function ElderPastMeasurmentsHeight() {
  ...
  const fetchGrowthData = async () => {
    ...
    if(result.success){
      ...
      setElderInfo(result.elder_info);
    }
    else{
      setLatestGrowthData([]); 
      setElderInfo([]);
        ...
        <div className='app-top-box d-flex align-items-center justify-content-between'>
          <div className='app-top-left d-flex align-items-center'>
            <div className='scroll-back'>
              <Link to={`/elderpersons/growth-tracker/${editAccountKey}/${redirectedFrom}`} className=''>
          ...
          <tbody>
            {
              latestGrowthData.map( (measurement, index) => (
                <tr key={`weight${index}`}>
                  ...
                  <td>{elderInfo.elder_age} Years</td>
...
export default ElderPastMeasurmentsHeight;