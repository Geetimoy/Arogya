...
function ElderProfilePhoto(){
                ...
                <div className="row">
                  <div className="col-12">
                    ...
                    <div className="btns-group d-flex justify-content-center">
                      ...
                      <Link to="/elder-persons"><button type="button" className="btn btn-primary primary-bg-color border-0 mx-1">Cancel</button></Link>
                    </div>
                  </div>
                </div>
              </div>
 ...
 export default ElderProfilePhoto;