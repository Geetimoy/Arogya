...
import { faSearch, faEllipsisV, faLongArrowAltLeft } from '@fortawesome/free-solid-svg-icons';
...
function CreateElderPersonDoctor() {
  ...
  const resetForm = () => {
    ...
    const handleFormSubmit = async (e) => {
      ...
      if(errorCounter === 0){
        ...
        const response = await fetch(`${API_URL}/addUpdateElderProfileFromDoctorLogin`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
export default CreateElderPersonDoctor;