...
function ElderUploadDoctorPrescriptions(){
  ...
  const handleFormSubmit = async (e) => {
    ...
    if(errorCounter === 0){
      ...
      if(fileUploadErrorCounter > 0){
        ...
        const response = await fetch(`${API_URL}/uploadAppointmentDocumentForElder`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
export default ElderUploadDoctorPrescriptions;