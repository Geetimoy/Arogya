...
import './ChildUploadPrescription.css'
import AppTopNotifications from '../AppTopNotifications';

function ChildUploadInitialPrescriptionsDoctor(){
        ...
        <div className='app-top-box d-flex align-items-center justify-content-between'>
          <div className='app-top-left d-flex align-items-center'>
            <div className='scroll-back'>
              <Link to={`/childmalnutrition/child-prescription/${editAccountKey}/${prescriptionType}`} className=''>
...
export default ChildUploadInitialPrescriptionsDoctor;