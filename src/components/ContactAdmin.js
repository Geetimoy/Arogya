    ...
    <div className='container'>
      <div className='login-container'>
        ...
        <div className='login-box contact-admin'>
          ...
          <p className='text-left'><FontAwesomeIcon icon={faEnvelope} /> <strong>Email ID:</strong> <Link to="mailto:serviceplace@gmail.com" className='primary-color'> serviceplace@gmail.com</Link></p>
